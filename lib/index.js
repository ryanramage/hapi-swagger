...
const schema = Joi.object({
    ...
    swaggerUIPathModifiesRoutes: Joi.boolean(),
...
exports.register = function (plugin, options, next) {
    ...
    const jsonPath = (useDefaultPathsInRoutes) ? defaults.jsonPath : settings.jsonPath;
    ...
    if (settings.enableDocumentation === true) {
        ...
        plugin.dependency(['inert', 'vision'], (pluginWithDependencies, nextWithDependencies) => {
            ...
            const swaggerUIPath = (useDefaultPathsInRoutes) ? defaults.swaggerUIPath : settings.swaggerUIPath;
